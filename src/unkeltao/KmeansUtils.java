...
public class KmeansUtils {
	...
	public static final String PRE_PROCESS_INPUT_PATH = "input";

	public static final String PRE_PROCESS_OUTPUT_PATH = "output" + TS + "/preProcess";

	public static final String CANOPY_CENTER_OUTPUT_PATH = "output" + TS + "/canopyCenter";

	public static final String CANOPY_CLUSTER_OUTPUT_PATH = "output" + TS + "/canopyCluster";

	public static final String KMEANS_CENTER_OUTPUT_PATH = "output" + TS + "/kmeansCenter";

	public static final String KMEANS_CLUSTER_OUTPUT_PATH = "output" + TS + "/kmeansCluster";
